-- Reconstruct public-code previews from every active normalized field when the
-- legacy project snapshot is incomplete. Keep the existing rate limit and the
-- saved-project visibility boundary.
