...
test('header uses the Vivai Obice logo asset instead of the VO placeholder', () => {
  assert.match(html, /class="brand-logo"[^>]+src="\.\/assets\/logo-vivai-obice-v14\.png\?v=14"/);
  assert.ok(fs.existsSync(new URL('../assets/logo-vivai-obice-v14.png', import.meta.url)));
